...
namespace S3KObjectDefinitions.Common
{
	...
	class Spikes : ObjectDefinition
	{
		...
		protected void BuildSpritesProperties(bool competition, byte[] vertart)
		{
			...
			{
				map = LevelData.ASMToBin("../data/mappings/08 - Spikes.asm", LevelData.Game.MappingsVersion);
				horzart = LevelData.ReadFile("../data/art/SpkSpngs.nem", CompressionType.Nemesis);
				if (vertart == null)
				{
