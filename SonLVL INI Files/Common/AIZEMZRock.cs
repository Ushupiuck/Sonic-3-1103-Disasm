...
{
	class Rock : Common.AIZEMZRock
	{
		public override void Init(ObjectData data)
		{
			BuildSpritesProperties("../data/AIZ/rocktree.nem",
				"../data/mappings/05 - AIZ1 Rock.asm", 0, 1, 0x04,
	...
	class Rock2 : Common.AIZEMZRock
	{
		public override void Init(ObjectData data)
		{
			BuildSpritesProperties("../data/AIZ/misclns.nem",
				"../data/mappings/05 - AIZ2 Rock.asm", 0, 2, 0x04,
				new Dictionary<string, int>
				{
					{ "Large", 0 },
					{ "Medium", 1 },
...
namespace S3KObjectDefinitions.EMZ
{
	class Rock : Common.AIZEMZRock
	{
		public override void Init(ObjectData data)
		{
			BuildSpritesProperties("../data/EMZ/rockmisc.nem",
				"../data/mappings/05 - EMZ Rock.asm", -3, 3, 0x31,
				new Dictionary<string, int>
				{
					{ "Square", 3 }
				});
...
{
	abstract class AIZEMZRock : ObjectDefinition
	{
