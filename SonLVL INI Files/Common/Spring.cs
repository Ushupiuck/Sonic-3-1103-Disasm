...
namespace S3KObjectDefinitions.Common
{
	...
	class Spring : ObjectDefinition
	{
		...
		{
			BuildSpritesProperties(
				"../data/art/SpkSpngs.nem", "Offset_0x019C46", "Offset_0x019C6A", -512,
				"../data/art/SpkSpngs.nem", "Offset_0x019C8E", "Offset_0x019CB2", -1024,
				"../data/mappings/07 - Springs.asm", false);
		}
