...
namespace S3KObjectDefinitions.AIZ
{
	class FallingLog2 : FallingLog
	{
		public override void Init(ObjectData data)
		{
			BuildSpritesProperties(
				"../data/AIZ/Misclns.nem",
				"../data/mappings/2D - AIZ2 Falling Log.asm",
				"../data/mappings/2D - AIZ2 Falling Log Splash.asm", 3);
		}
	}
	...
	class FallingLog : ObjectDefinition
	{
		...
		{
			BuildSpritesProperties(
				"../data/AIZ/corkflr.nem",
				"../data/mappings/2D - AIZ1 Falling Log.asm",
				"../data/mappings/2D - AIZ1 Falling Log Splash.asm", 2);
		}
