...
; Offset_0x036AB4:
				...
				bra.w	Boss_Hit_Check						   ; Offset_0x036FC0
;-------------------------------------------------------------------------------
Offset_0x036AC6:
...
;-------------------------------------------------------------------------------
Offset_0x036B9E:
				jsr		(Swing_Up_And_Down_Count).l			   ; Offset_0x0423B6
...
Offset_0x036C36:
				...
				bra.w	Swing_Setup							   ; Offset_0x03669A
Offset_0x036C3E:
				jsr		(Swing_Up_And_Down_Count).l			   ; Offset_0x0423B6
...
Offset_0x036FF2:
				...
				jsr		(Move_0x08_Bytes_A2_A1).l				   ; Offset_0x04325C
