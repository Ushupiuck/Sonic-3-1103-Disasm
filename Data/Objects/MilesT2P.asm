...
Offset_0x00F340:
				lea		(Miles_Tails_2P_Animate_Data).l, A1		 ; Offset_0x00F376
				bsr.w	Miles_Animate_Sprite_2P_A1			   ; Offset_0x00EDD6
				bsr.w	Load_Miles_Tails_Dynamic_PLC_2P		   ; Offset_0x00F122
