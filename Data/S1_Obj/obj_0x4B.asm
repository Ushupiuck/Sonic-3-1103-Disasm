...
Offset_0x010C76:
                ...
                ori.b   #4,Obj_Flags(A0)                              ; $0004
                move.b  #$40,Obj_Width(A0)                              ; $0007
                tst.b   Obj_Flags(A0)                                    ; $0004
                bpl.s   Offset_0x010CC0
                cmpi.b  #6,(SS_Completed_Flag).w                  ; $FFFFFFB0
...
Offset_0x010CAA:
                ...
                move.w  #$100,Obj_Priority(A0)                         ; $0008
                move.b  #$52,Obj_Col_Flags(A0)                          ; $0028
                move.w  #$C40,(S1_Load_Big_Ring_Art_Flag).w        ; $FFFFF7BE
;-------------------------------------------------------------------------------                
Offset_0x010CC0:
...
;------------------------------------------------------------------------------- 
Offset_0x010CDE:
                subq.b  #2,Obj_Routine(A0)                            ; $0005
                move.b  #0,Obj_Col_Flags(A0)                          ; $0028
