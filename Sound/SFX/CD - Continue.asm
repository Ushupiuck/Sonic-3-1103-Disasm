Sound_CD_Header:
	...
	smpsHeaderSFXChannel cFM3, Sound_CD_FM3,	$F4, $06
	smpsHeaderSFXChannel cFM4, Sound_CD_FM4,	$F4, $06
	smpsHeaderSFXChannel cFM5, Sound_CD_FM5,	$F4, $06
...
Sound_CD_Loop02:
	dc.b	nG6, $07, nB6, nD7
	smpsFMAlterVol      $05
	smpsLoop            $00, $08, Sound_CD_Loop02
	smpsStop
...
Sound_CD_Loop01:
	dc.b	nB6, $15
	smpsFMAlterVol      $05
	smpsLoop            $00, $08, Sound_CD_Loop01
	smpsStop
...
Sound_CD_Loop00:
	dc.b	nG6, $15
	smpsFMAlterVol      $05
	smpsLoop            $00, $08, Sound_CD_Loop00
	smpsStop
