Sound_86_Header:
	...
	smpsHeaderSFXChannel cFM5, Sound_86_FM5,	$FA, $00
	smpsHeaderSFXChannel cPSG3, Sound_86_PSG3,	$04, $00
...
Sound_86_Loop00:
	dc.b	nEb6, $02
	smpsFMAlterVol      $05
	smpsLoop            $00, $05, Sound_86_Loop00
	smpsStop
...
Sound_86_Loop01:
	dc.b	nE6, $05
	smpsPSGAlterVol     $02
	smpsLoop            $00, $0C, Sound_86_Loop01
	smpsStop
