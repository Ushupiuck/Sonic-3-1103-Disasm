Sound_97_Header:
	...
	smpsHeaderSFXChannel cFM5, Sound_97_FM5,	$00, $03
	smpsHeaderSFXChannel cFM4, Sound_97_FM4,	$DF, $00
	smpsHeaderSFXChannel cPSG3, Sound_97_PSG3,	$20, $00
...
Sound_97_Loop00:
	dc.b	nC4, $0F
	smpsPSGAlterVol     $0B
	smpsLoop            $00, $03, Sound_97_Loop00
	smpsStop
